...
export default class Rainbow {
  gradients: Array<ColourGradient>;
  minNum: number = 0;
  maxNum: number = 100;
  ...
  setColours = function (this: any, spectrum: Array<string>) {
  ...
  setSpectrum = function (this: any, ...args: string[]) {
    this.setColours(args);
    return this;
  };

  setSpectrumByArray = function (this: any, array: Array<string>) {
    this.setColours(array);
    return this;
  };

  colourAt = function (this: any, number: number) {
    if (isNaN(number)) {
  ...
  setNumberRange = function (this: any, minNumber: number, maxNumber: number) {
...
class ColourGradient {
  ...
  setGradient = function (this: any, colourStart: string, colourEnd: string) {
  ...
  isHexColour(string: string) {
    var regex = /^#?[0-9a-fA-F]{6}$/i;
    return regex.test(string);
  }

  getHexColour(this: any, string: string): string {
    if (this.isHexColour(string)) {
      return string.substring(string.length - 6, string.length);
    } else {
      var name: string = string.toLowerCase();
